...
public class RequestDAOImpl extends AbstractHibernateDAO<Request> {
	...
	public List<IpepRequest> getIPRequestNo(String proxy, String proxy_emp_no,
			String requestor_emp_no) {
		return em.createNamedQuery("getIPRequestNo")
				.setParameter("proxy", proxy)
				.setParameter("proxy_emp_no", proxy_emp_no)
				.setParameter("requestor_emp_no", requestor_emp_no)
				.getResultList();
	}

	@Transactional(rollbackFor = RuntimeException.class, propagation = Propagation.REQUIRED)
	public String createRequest(TODBRequest todbRequest) throws Exception {
		String pubNo = null;
		...
		if (extAuthors != null)
			for (ExternalAuthor ea : extAuthors) {
				...
				ePk = ea.getExternalAuthorPK();
				ePk.setRequestNo(requestNo);
	...
	private String createPublicationNo(String requestNo) throws Exception {
	...
	private String startProcess(String requestNo, String empNo) throws Exception {
		CallableStatement callableStatement;
		String result = null;
